...
#distribute
cluster = tf.train.ClusterSpec({'worker':['10.10.1.140:2222','10.10.1.141:2222']})
server = tf.train.Server(cluster,task_index=1)
...
def train_neural_network(x, hm_epochs=2):
    ...
    with tf.train.MonitoredTrainingSession(master=server.target, is_chief=False) as ses:
